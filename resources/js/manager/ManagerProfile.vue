                    ...
                    >
                        ...
                        >
                            {{
                                manager.Admin == 1
                                    ? 'Admin'
                                    : 'Undefined' && manager.Secretary == 1
                                    ? 'Secretary'
                                    : 'Undefined' && manager.Manager == 1
                                    ? 'Manager'
                                    : 'Undefined' && manager.Customer == 1
                                    ? 'Customer'
                                    : 'Undefined'
                            }}
                        </h3>
                    ...
                    <div class="bg-white p-3 shadow-sm rounded-sm">
                        ...
                        <div class="text-gray-700">
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                ...
                                <div v-if="manager.age == null">
                                    <button
                                        v-if="!managerEditAge"
                                        @click="managerEditAge = true"
                                ...
                                <div v-if="manager.birth_date == null">
                                    <button
                                        v-if="!managerEditBirthDate"
                                        @click="managerEditBirthDate = true"
                                        class="p-2 text-gray-200 bg-gray-800 hover:bg-gray-400 hover:text-gray-50 rounded transition duration-300"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div v-show="managerEditBirthDate">
                                        <input
                                            class="w-full focus:bg-white border-2 border-gray-200 p-2 rounded outline-none focus:border-gray-800 transition duration-150"
                                            type="date"
                                            v-model="manager.birth_date"
                                        />
                                    </div>
                                </div>
                                <div v-if="manager.birth_date != null">
                            ...
                            <div class="grid grid-cols-4 gap-4 mt-4">
                                ...
                                <div v-if="manager.gender == null">
                                    <button
                                        v-if="!managerEditGender"
                                        @click="managerEditGender = true"
                                        class="p-2 text-gray-200 bg-gray-800 hover:bg-gray-400 hover:text-gray-50 rounded transition duration-300"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                ...
                                <div v-if="manager.contact_num == null">
                                    <button
                                        v-if="!managerEditContact"
                                        @click="managerEditContact = true"
                                        class="p-2 text-gray-200 bg-gray-800 hover:bg-gray-400 hover:text-gray-50 rounded transition duration-300"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div v-show="managerEditContact">
                                        <input
                                            class="w-full focus:bg-white border-2 border-gray-200 p-2 rounded outline-none focus:border-gray-800 transition duration-150"
                                            type="text"
                                            v-model="manager.contact_num"
                                        />
                                    </div>
                                </div>
                                <div v-if="manager.contact_num != null">
                                ...
                                <div v-if="manager.address == null">
                                    <button
                                        v-if="!managerEditAddress"
                                        @click="managerEditAddress = true"
                                        class="p-2 text-gray-200 bg-gray-800 hover:bg-gray-400 hover:text-gray-50 rounded transition duration-300"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
...
export default {
    data() {
        return {
            ...
            loadingImage: false,
            preview: false,
            managerEditAge: false,
            managerEditBirthDate: false,
            managerEditGender: false,
            managerEditContact: false,
            managerEditAddress: false,
            manager: {},
            image: '',
    ...
    methods: {
        ...
        updateUser() {
            ...
            setTimeout(() => {
                this.loading = !true;
                axios
                    .put(`/api/users/${this.$route.params.id}`, this.manager)
                    .then(() => {
                        this.$swal({
                            position: 'center',
                            icon: 'success',
        ...
        onChange(e) {
            ...
            axios
                ...
                .then(response => {
                    this.manager.image = response.data;
                    console.log(response.data);
                })
                .catch(error => {
                    this.errors = error.response.data.errors;
