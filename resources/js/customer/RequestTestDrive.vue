                    ...
                    <div class="sm:w-full lg:w-2/5 bg-white rounded shadow-md">
                        ...
                        >
                            <p class="text-xs text-gray-600">
                                Please enter your details and preferred date of
                                test drive and we'll coordinate with the staff
                                on your behalf. The staff will contact you in
                                due course to finalize your appointment.
                            </p>
                        </div>
