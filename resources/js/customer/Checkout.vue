                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex mt-2 mb-4">
                                    <p class="text-gray-800 text-md italic">
                                        To all our dear customers please be
                                        advised that we will implement a maximum
                                        customer capacity each day in response
                                        to the health protocols. Since we cannot
                                        serve you all at once we will have an
                                        online scheduling of appointments. There
                                        you can choose the type of service you
                                        want to avail and also the date and
                                        time, after that our staff will evaluate
                                        if there is an available time slot for
                                        you to be entertained immediately. And
                                        if there is an available time slot we
                                ...
                                <div class="flex mb-4">
                                    <p
                                        class="text-red-700 font-semibold text-md italic"
                                    >
                                        YOU CAN STILL CANCEL YOUR ORDERS IF NOT
                                        YET APPROVED. ONCE YOUR ORDER HAS BEEN
                                        APPROVED. YOUR ORDERS WILL BE DELIVERED.
                                        YOU CAN CONTACT US FOR TRACKING YOUR
                                        ORDERS
                                    </p>
                                </div>
