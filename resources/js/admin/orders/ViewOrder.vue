        ...
        <div class="container">
            <nav class="text-black font-bold my-8" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <router-link to="/orders">Order Management</router-link>
                        <svg
                            class="fill-current w-3 h-3 mx-3"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 320 512"
                ...
                <div class="flex mt-4">
                    ...
                    <div class="flex w-1/2">
                        <div class="p-4">
                            ...
                            <div class="flex mt-4">
                                <h5
                                    class="font-sans font-bold text-md text-gray-800 mr-2"
                                >
                                    Product Name:
                                </h5>
                                <h5 class="font-sans text-md text-gray-800">
                            ...
                            <div class="flex mt-2">
                                <h5
                                    class="font-sans font-bold text-gray-800 mr-2"
                                >
                                    Description:
                                </h5>
                            </div>
            ...
            <div class="bg-white p-4 shadow-md mt-4">
                <div class="flex mb-4">
                    <h5 class="font-sans font-bold text-lg text-gray-800 mr-2">
                        User Information
                    </h5>
                </div>
                <div class="flex">
                    <h5 class="font-sans font-bold text-md text-gray-800 mr-2">
                        Ordered By:
                    </h5>
                    <h5 class="font-sans text-md text-gray-800">
                        {{ order.user.fname }}
