        ...
        <div class="container">
            <div v-if="!isLogged">
                <div class="flex items-center justify-center mt-20">
                    <div class="p-2 w-1/3 mr-10 mb-52">
                        <div class="flex">
                            <p
                        ...
                        <div class="flex mt-4">
                            ...
                            >
                                ...
                                Wholesaler designed to provide an online
                                platform to the company employees to help them
                                in performing their work effortlessly.
                            </p>
                        </div>
                    </div>
